...
def parseArgs():
    ...
    parserShell.add_argument('-f', '--file', help="use a file containing a " +
    ...
    parserCmd.add_argument('-f', '--file', help="use a file containing a " +
                  "list of binaries \(one per line\) instead of a single " +
                  "binary", action='store_const', const=parseFile, dest='func')
    ...
    parserRev.add_argument('-f', '--file', help="use a file containing a " +
                  "list of binaries \(one per line\) instead of a single " +
                  "binary", action='store_const', const=parseFile, dest='func')
    ...
    parserNrev.add_argument('-f', '--file', help="use a file containing a " +
                  "list of binaries \(one per line\) instead of a single " +
                  "binary", action='store_const', const=parseFile, dest='func')
    ...
    parserBind.add_argument('-f', '--file', help="use a file containing a " +
                  "list of binaries \(one per line\) instead of a single " +
                  "binary", action='store_const', const=parseFile, dest='func')
    ...
    parserNbind.add_argument('-f', '--file', help="use a file containing a " +
                  "list of binaries \(one per line\) instead of a single " +
                  "binary", action='store_const', const=parseFile, dest='func')
    ...
    parserUpload.add_argument('-f', '--file', help="use a file containing a " +
                  "list of binaries \(one per line\) instead of a single " +
                  "binary", action='store_const', const=parseFile, dest='func')
    ...
    parserDownload.add_argument('-f', '--file', help="use a file containing " +
                  "a list of binaries \(one per line\) instead of a single " +
                  "binary", action='store_const', const=parseFile, dest='func')
    ...
    parserWrite.add_argument('-f', '--file', help="use a file containing a " +
                  "list of binaries \(one per line\) instead of a single " +
                  "binary", action='store_const', const=parseFile, dest='func')
    ...
    parserRead.add_argument('-f', '--file', help="use a file containing a " +
                  "list of binaries \(one per line\) instead of a single " +
                  "binary", action='store_const', const=parseFile, dest='func')
    ...
    parserLoad.add_argument('-f', '--file', help="use a file containing a " +
                  "list of binaries \(one per line\) instead of a single " +
                  "binary", action='store_const', const=parseFile, dest='func')
    ...
    parserSuid.add_argument('-f', '--file', help="use a file containing a " +
                  "list of binaries \(one per line\) instead of a single " +
                  "binary", action='store_const', const=parseFile, dest='func')
    ...
    parserSudo.add_argument('-f', '--file', help="use a file containing a " +
                  "list of binaries \(one per line\) instead of a single " +
                  "binary", action='store_const', const=parseFile, dest='func')
    ...
    parserCap.add_argument('-f', '--file', help="use a file containing a " +
                  "list of binaries \(one per line\) instead of a single " +
                  "binary", action='store_const', const=parseFile, dest='func')
    ...
    parserLsuid.add_argument('-f', '--file', help="use a file containing a " +
                  "list of binaries \(one per line\) instead of a single " +
                  "binary", action='store_const', const=parseFile, dest='func')
    ...
    parserAll.add_argument('-f', '--file', help="use a file containing a " +
                  "list of binaries \(one per line\) instead of a single " +
                  "binary", action='store_const', const=parseFile, dest='func')
